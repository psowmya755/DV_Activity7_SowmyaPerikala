function scatter_plot(
    ...
    Fig.selectAll(".markers")
        ...
        // id has index so we can map back into data array
    ...
    function brushStart() {
        ...
        // If there is no real brush selection (user just clicked),
    ...
    // Only one category filtered at a time
    let activeCategory = null;

    ////////////////////////////////////////////////////////////////////////
    // Missing Part 5 : clicking legend filters points
    ////////////////////////////////////////////////////////////////////////
    legends_items.on("click", function (event, d) {
        if (activeCategory === d) {
            // clicking again resets
            activeCategory = null;
            d3.selectAll("circle").classed("legendSelect", false);
        } else {
            activeCategory = d;
            d3.selectAll("circle").classed("legendSelect", p => p[colorCol] !== d);
        }
    });
